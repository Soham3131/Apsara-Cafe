  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <button className="mt-8 bg-yellow-500 hover:bg-yellow-600 text-amber-900 font-bold py-3 px-8 rounded-full text-lg transition duration-300 transform hover:scale-105 shadow-xl">
